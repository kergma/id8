...
$$
	select ((100*extract(epoch from $1))::int8::bit(40)||nextval('id_helper')::bit(12)||systemid()::bit(12))::bit(64)::int8;
$$
language sql volatile;
...
$$
	select ((100*extract(epoch from $1))::int8::bit(40)||'000000000000000000000000')::bit(64)::int8;
$$
language sql immutable;

create or replace function timestamp_of_id(i int8) returns timestamp with time zone as
$$
	select timestamp with time zone 'epoch' + substring($1::bit(64) from 1 for 40)::int8::double precision/100*interval '1 second';
$$
language sql immutable;
